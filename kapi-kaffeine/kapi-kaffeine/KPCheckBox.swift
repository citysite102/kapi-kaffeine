...
//                return M13CheckboxDotController(style: style)
     ...
     */
    func toggleCheckState(_ animated: Bool = false) {
        switch checkState {
        case .checked:
    ...
    var stateChangeAnimation: Animation = .bounce(AnimationStyle.fill) {
        didSet {
...
//        }
    ...
    var secondaryCheckmarkTintColor: UIColor? {
        get {
    ...
    open override func layoutSubviews() {
        ...
        controller.pathGenerator.size = min(frameSize.width, frameSize.height)
