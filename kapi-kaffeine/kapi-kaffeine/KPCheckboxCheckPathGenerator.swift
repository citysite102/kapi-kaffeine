//
//  KPCheckboxCheckPathGenerator.swift
//  kapi-kaffeine
//
...
class KPCheckboxCheckPathGenerator: KPCheckBoxPathGenerator {
    ...
    struct CheckmarkProperties {
        ...
        var longArmBoxIntersectionAngle: CGFloat = 45.0 * CGFloat(CGFloat.pi / 180.0)
    ...
    override func pathForCircle() -> UIBezierPath? {
        ...
        return UIBezierPath(arcCenter: CGPoint(x: size / 2.0, y: size / 2.0),
                            ...
                            endAngle: CGFloat(2 * CGFloat.pi) - checkmarkProperties.longArmBoxIntersectionAngle,
                            clockwise: true)
    }
    ...
    override func pathForRoundedRect() -> UIBezierPath? {
        ...
        if cornerRadius != 0 {
            path.addArc(withCenter: tr,
                        ...
                        endAngle: CGFloat.pi+CGFloat.pi/2+CGFloat.pi/4,
                        clockwise: true)
        }
        path.close()
        return path
