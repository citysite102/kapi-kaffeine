...
protocol KPSearchFooterViewDelegate: NSObjectProtocol {
...
class KPSearchFooterView: UIView {
    ...
    weak var delegate: KPSearchFooterViewDelegate?
...
extension KPSearchFooterView: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        self.delegate?.searchFooterView(self,
                                        didSelectItemWith: demoFooterTagContents[indexPath.row])
    }
