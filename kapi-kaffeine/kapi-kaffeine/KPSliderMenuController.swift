...
open class KPSliderMenuController: UIViewController, UIGestureRecognizerDelegate {
...
extension UIViewController {
    ...
    public func slideMenuController() -> KPSliderMenuController? {
        var viewController: UIViewController? = self
        while viewController != nil {
            if viewController is KPSliderMenuController {
                return viewController as? KPSliderMenuController
            }
